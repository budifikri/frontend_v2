...
const IMPLEMENTED_TOOLS = new Set(['warehouse', 'satuan', 'categori', 'product', 'customer', 'supplier', 'company', 'theme', 'user', 'lapstok', 'laphargagrosir', 'opname', 'beli', 'receive', 'retur', 'promotion', 'lapcashdrawer', 'report_setting'])
